...
/* Command for C compiler:
   clang++ -c -std=gnu++17 -funsigned-char  -pthread -fPIC  -O3 -fno-ident  -fPIC  -I/opt/homebrew/Cellar/nim/2.2.0/nim/lib -I/Users/siddarthkumar/code/siddarthkay/react-native-nim/nim-core/src -o /Users/siddarthkumar/code/siddarthkay/react-native-nim/bindings/ios/@mmobile@sbindings.nim.cpp.o /Users/siddarthkumar/code/siddarthkay/react-native-nim/bindings/ios/@mmobile@sbindings.nim.cpp */
...
LA14_: ;
 ...
 deallocShared(colontmpD_.p);
	...
	result = allocCString__apiZcore_u2(result_2);
...
N_LIB_EXPORT N_CDECL(NCSTRING, mobileCreateUser)(int id_p0, NCSTRING name_p1, NCSTRING email_p2) {
	NCSTRING result;
	tyObject_User__f6PlpG8HkkZuH5Hx2Zl1Tg user;
	NimStringV2 colontmpD_;
	NimStringV2 colontmpD__2;
	NimStringV2 colontmpD__3;
	std::exception_ptr T2_;
{	result = (NCSTRING)0;
	nimZeroMem((void*)(&user), sizeof(tyObject_User__f6PlpG8HkkZuH5Hx2Zl1Tg));
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	...
	createUser__businessZdata_u8(((NI) (id_p0)), colontmpD_, colontmpD__2, (&user));
	colontmpD__3 = userToJson__businessZdata_u34((&user));
	result = allocCString__apiZcore_u2(colontmpD__3);
 ...
 deallocShared(colontmpD_.p);
	...
	eqdestroy___businessZdata_u16((*(&user)));
	goto BeforeRet_;
	}
	catch (Exception* T3_) {
	T2_ = std::current_exception();
...
{	result = (int)0;
	...
	try {
	{
		...
		auto T5_ = validateEmail__businessZdata_u4083(colontmpD_);
		if (!T5_) goto LA6_;
{		colontmpD__2 = ((int)1);
		result = colontmpD__2;
}	}
