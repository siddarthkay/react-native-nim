...
/* Command for C compiler:
   clang++ -c -std=gnu++17 -funsigned-char  -pthread -fPIC  -O3 -fno-ident  -fPIC  -I/opt/homebrew/Cellar/nim/2.2.0/nim/lib -I/Users/siddarthkumar/code/siddarthkay/react-native-nim/nim-core/src -o /Users/siddarthkumar/code/siddarthkay/react-native-nim/bindings/ios/@mapi@score.nim.cpp.o /Users/siddarthkumar/code/siddarthkay/react-native-nim/bindings/ios/@mapi@score.nim.cpp */
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING, allocCString__apiZcore_u2)(NimStringV2 s_p0);
...
extern "C" N_LIB_EXPORT N_CDECL(void, freeString)(NCSTRING s_p0);
static N_INLINE(NIM_BOOL, eqeq___system_u7695)(NCSTRING x_p0, NCSTRING y_p1);
...
N_LIB_PRIVATE N_NIMCALL(NCSTRING, allocCString__apiZcore_u2)(NimStringV2 s_p0) {
	NCSTRING result;
	NI TM__67Pf0KKQCE3cSgIGvfOk8A_19;
{	result = (NCSTRING)0;
	if (nimAddInt(s_p0.len, ((NI)1), &TM__67Pf0KKQCE3cSgIGvfOk8A_19)) { raiseOverflow(); 	};
	if (((NI)(TM__67Pf0KKQCE3cSgIGvfOk8A_19)) < ((NI)0) || ((NI)(TM__67Pf0KKQCE3cSgIGvfOk8A_19)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__67Pf0KKQCE3cSgIGvfOk8A_19), ((NI)0), ((NI)IL64(9223372036854775807))); 	}
	auto T1_ = alloc0Impl__system_u1744(((NI)(TM__67Pf0KKQCE3cSgIGvfOk8A_19)));
	NCSTRING cstr = ((NCSTRING) (T1_));
	if ((s_p0.len) < ((NI)0) || (s_p0.len) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI(s_p0.len, ((NI)0), ((NI)IL64(9223372036854775807))); 	}
	copyMem__system_u1726(((void*) (cstr)), ((void*) (nimToCStringConv(s_p0))), (s_p0.len));
	result = cstr;
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
...
appendString(fmtRes, TM__67Pf0KKQCE3cSgIGvfOk8A_4);
		formatValue__apiZcore_u28((*(&fmtRes)), TM__67Pf0KKQCE3cSgIGvfOk8A_8);
		prepareAdd(fmtRes, 4);
appendString(fmtRes, TM__67Pf0KKQCE3cSgIGvfOk8A_10);
		formatValue__apiZcore_u28((*(&fmtRes)), TM__67Pf0KKQCE3cSgIGvfOk8A_12);
		prepareAdd(fmtRes, 2);
appendString(fmtRes, TM__67Pf0KKQCE3cSgIGvfOk8A_14);
		formatValue__apiZcore_u28((*(&fmtRes)), TM__67Pf0KKQCE3cSgIGvfOk8A_16);
		prepareAdd(fmtRes, 1);
appendString(fmtRes, TM__67Pf0KKQCE3cSgIGvfOk8A_18);
		info = fmtRes;
	}
	result = allocCString__apiZcore_u2(info);
...
LA8_: ;
	{
		auto T11_ = strcmp(x_p0, y_p1);
		result = (T11_ == ((NI32)0));
	}
LA1_: ;
	return result;
}
N_LIB_EXPORT N_CDECL(void, freeString)(NCSTRING s_p0) {
	{
		auto T3_ = eqeq___system_u7695(s_p0, ((NCSTRING) NIM_NIL));
		if (!!(T3_)) goto LA4_;
{		dealloc(((void*) (s_p0)));
}	}
LA4_: ;
